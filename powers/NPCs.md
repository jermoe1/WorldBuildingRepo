# NPCs.md
> Named characters — background, role, motivations, relationships, current whereabouts and status.
> All entries must be consistent with the Canon Registry in WorldBuildingAssistant.md.
> Cross-reference: Factions.md (affiliations), Geography.md (locations), Gods.md (faith), Relationships.md (personal connections).

---

## HOW TO USE THIS FILE

Each named character gets an entry. Player characters are not recorded here — this file is for the world's inhabitants. Keep the Current Status field updated as characters act in play. When a character dies or changes allegiance, update their entry and log the event in Timeline.md.

### Entry Template

```
### [Character Name]
**Also Known As:** [Titles, aliases, epithets]
**Role:** [What function does this character serve in the world — not in game terms, but narratively]
**Status:** Alive / Dead / Unknown / Missing
**Location:** [Where are they now? Cross-reference Geography.md]
**Faction Affiliation:** [Cross-reference Factions.md]
**Faith:** [Cross-reference Gods.md]

**Appearance**
[Physical description — distinctive features, how they present themselves]

**Background**
[Where did they come from? What shaped them?]

**Personality & Voice**
[How do they speak and behave? What are their defining traits?]

**Motivations**
- **Wants:** [What are they actively pursuing?]
- **Needs:** [What do they actually need, whether they know it or not?]
- **Fears:** [What do they avoid or dread?]

**Capabilities**
[What are they good at? Any notable skills, powers, or resources?]

**Relationships**
[Key connections — cross-reference Relationships.md]

**History**
[Key events in their past — cross-reference Timeline.md]

**Current Situation**
[What are they doing now? What pressures are they under?]

**Plot Hooks**
[What could bring player characters into contact with this person, and why would that be interesting?]
...
**Location:** Unknown / Wandering — no fixed location
**Faction Affiliation:** None known
**Faith:** Unknown

**Appearance**
*(unknown — name implies something red, whether clothing, armor, or something more visceral)*

**Background**
*(unknown — origin, history, and true identity undefined)*

**Personality & Voice**
Merciless and purposeful. Neither confirmed Good nor Evil — the alignment is genuinely ambiguous and should remain so until intentionally revealed.
...
**Capabilities**
Rumored to gain life by taking it from targets — some form of life-siphoning ability. Whether this is confirmed in-world or purely legend is undefined.

**Relationships**
*(unknown)*

**History**
*(unknown — a legendary figure; historical record may be distorted, exaggerated, or suppressed)*

**Current Situation**
Wandering. Unknown destination or purpose.

**Plot Hooks**
- A life-drain ability makes them a credible threat to even experienced adventurers.
- Ambiguous alignment means players cannot assume they are an enemy — or an ally.
- Their motives are unknown: are they hunting someone? Fulfilling an obligation? Driven mad? Seeking something?

**Notes & Open Questions:**
- Is "The Red Death" an in-world name, a nickname, or an actual identity?
...
*— NPCs.md — Part of the WorldBuildingAssistant auxiliary file system —*
